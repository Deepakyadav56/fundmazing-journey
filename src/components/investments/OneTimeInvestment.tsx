  ...
  return (
    <Card className="max-w-md w-full mx-auto">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-3 bg-fundeasy-light-gray rounded-md flex gap-2">
          <AlertCircle className="h-5 w-5 text-fundeasy-green shrink-0" />
        ...
        <div className="border-t border-gray-100 pt-4">
          <div className="flex justify-between text-sm">
            ...
            <span>₹{fund.navValue.toFixed(2)}</span>
          </div>
          <div className="flex justify-between text-sm mt-1">
            <span>Estimated units</span>
            <span>{(amount / fund.navValue).toFixed(3)}</span>
          </div>
        </div>
      </CardContent>
      ...
      <CardFooter className="flex justify-between">
        ...
        <Button onClick={() => onComplete(amount)}>

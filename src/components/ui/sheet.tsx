...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      <SheetPrimitive.Close className="absolute right-4 top-4 rounded-full p-1.5 bg-fundeasy-light-gray hover:bg-fundeasy-medium-gray opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-fundeasy-green focus:ring-offset-2 disabled:pointer-events-none">
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-fundeasy-dark-gray", className)}
    {...props}
  />
))
